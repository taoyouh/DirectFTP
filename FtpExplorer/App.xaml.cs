...
namespace FtpExplorer
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            using (var db = new Data.PasswordContext())
            {
                db.Database.Migrate();
            }
        ...
        {
            if (eventArgs.ViewSwitcher == null)
            {
                ApplicationViewSwitcher.DisableSystemViewActivationPolicy();

                CreateRootFrame(
                    eventArgs.PreviousExecutionState,
                    eventArgs.PrelaunchActivated,
                    null);
                var currentView = ApplicationView.GetForCurrentView();
                currentView.Consolidated += (sender, e) =>
                {
            ...
            else
            {
                ...
                await eventArgs.ViewSwitcher.ShowAsStandaloneAsync(viewId);
            }
        }
